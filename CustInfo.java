...
public class CustInfo extends javax.swing.JFrame {
    ...
    public CustInfo() {
        ...
        dtm.setRowCount(c);
        Vector<Vector<String>> s=d.getdata1(4);
        for(int i=0;i<c;i++)
        {
            for (int j=0;j<4;j++)
            {
    ...
    private void initComponents() {
        ...
        if (t1.getColumnModel().getColumnCount() > 0) {
            ...
            t1.getColumnModel().getColumn(0).setPreferredWidth(2);
            ...
            t1.getColumnModel().getColumn(2).setPreferredWidth(60);
